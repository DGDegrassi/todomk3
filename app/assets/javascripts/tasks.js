	$(function() {
		...
		// The taskHtml method takes in a JavaScript representation of the 
		// task and produces an HTML representation using <li> tags
		...
		// and API request to toggle the value of the 'done' field
